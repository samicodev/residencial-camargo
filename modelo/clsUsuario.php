...
class clsUsuario{
	...
	function verificarUsuario($usuario, $clave){
		$sql = "SELECT us.*, us.nombre as 'nombreusu', pe.nombre as 'rol' FROM usuario us INNER JOIN perfil pe ON us.idperfil=pe.idperfil WHERE us.usuario=:usuario AND us.clave=SHA1(:clave) AND us.estado=1";
