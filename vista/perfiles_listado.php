	...
	<tbody>
		...
		<tr class="<?= $class ?>">
			...
			<td>
				...
				<button type="button" class="btn btn-warning btn-sm" onclick="cambiarEstadoPerfil(<?= $value['idperfil'] ?>,0)"><i class="fa fa-times"></i> Anular</button>
				<?php }else{ ?>
			...
			<td><button type="button" class="btn btn-danger btn-sm" onclick="cambiarEstadoPerfil(<?= $value['idperfil'] ?>,2)"><i class="fa fa-trash"></i> Eliminar</button></td>
		</tr>
		<?php } ?>
	</tbody>
</table>
