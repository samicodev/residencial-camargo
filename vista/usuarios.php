      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <button type="button" class="btn btn-success" onclick="abrirModalUsuario()"><i class="fas fa-plus-circle"></i> Nuevo</button>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  function verListado(){
    $("#divListadoUsuario").html('<div class="loader"><div class="justify-content-center jimu-primary-loading"></div></div>');
    $.ajax({
      method: "POST",
  ...
  function validarFormulario(){
    ...
    if(clave==""){
      toastError('Ingrese la contraseña')
      $('#clave').addClass('is-invalid');
      correcto = false;
    }
    if(idperfil==""){
      toastError('Seleccione un peril')
      $('#idperfil').addClass('is-invalid');
      correcto = false;
    }
  ...
  function abrirModalUsuario(){
    ...
    $('#idperfil').removeClass('is-invalid');
