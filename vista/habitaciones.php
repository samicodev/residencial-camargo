        ...
        <div class="row">
          <div class="col-md-4">
            <div class="input-group">
              ...
              <input type="number" class="form-control" name="txtBusquedaHabitacion" id="txtBusquedaHabitacion" onkeyup="if(event.keyCode=='13'){ verListado(); }" >
            </div>
          </div>
          <div class="col-md-4">
            <div class="input-group">
          ...
          <div class="col-md-3">
            ...
            <button type="button" class="btn btn-success" onclick="abrirModalHabitacion()"><i class="fas fa-plus-circle"></i> Nuevo</button>
          </div>
        </div>
      </div>
      </div>
            ...
            <div class="modal-body">
              <form name="formHabitacion" id="formHabitacion">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="codigo" name="codigo" min="1" placeholder="Número de la habitación">
...
function guardarHabitacion(){
  ...
  function validarFormulario(){
    ...
    if(idTipoHabitacion==""){
      toastError('Seleccione el tipo de la habitacion');
