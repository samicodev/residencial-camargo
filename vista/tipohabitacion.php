...
<script>
  ...
  function verListado(){
    $("#divListadoTipoHabitacion").html('<div class="loader"><div class="justify-content-center jimu-primary-loading"></div></div>');
    $.ajax({
      method: "POST",
  ...
  function validarFormulario(){
    ...
    if(nombre==""){
      toastError('Ingrese un nombre para el tipo de habitacion')
      $('#nombre').addClass('is-invalid');
      correcto = false;
    }
    if(precio==""){
      toastError('Ingrese el precio del tipo de habitacion')
