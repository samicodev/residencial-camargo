      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <button type="button" class="btn btn-success" onclick="abrirModalPerfil()"><i class="fas fa-plus-circle"></i> Nuevo</button>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  function verListado(){
    $("#divListadoPerfil").html('<div class="loader"><div class="justify-content-center jimu-primary-loading"></div></div>');
    $.ajax({
      method: "POST",
